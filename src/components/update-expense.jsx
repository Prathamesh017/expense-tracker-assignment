...
import { showModal, updateExpense } from '../feature/expense/expenseSlice'
...
function UpdateExpense() {
  ...
  const showExpense = useSelector(
    (state) => state.expense.showModals.updateExpense,
  )
  const id = useSelector((state) => state.expense.selectedExpenseId)
  const allExpenses = useSelector((state) => state.expense.expenses)
  const selectedExpense = allExpenses.filter((expense) => {
            ...
            <div className="w-11/12 md:w-1/2">
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                <div className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t">
                  <h3 className="text-xl font-semibold">Update Expense</h3>
                </div>
                <form className="p-4 " onSubmit={handleSubmit(onSubmit)}>
                  <div className="mt-2">
                    ...
                    <div className="flex flex-col items-start">
                      <input
                        type="text"
                        defaultValue={selectedExpense[0].name}
                  ...
                  <div className="mt-2">
                    ...
                    <div className="flex flex-col items-start">
                      <input
                        type="text"
                        defaultValue={selectedExpense[0].description}
                        className="block w-full mt-1 text-lg p-1 text-slate-900 border-gray-300 rounded-md border border-black-700 "
                  ...
                  <div className="mt-2">
                    ...
                    <select
                      ...
                      defaultValue={selectedExpense[0].category}
                  ...
                  <div className="mt-2">
                    ...
                    <div className="flex flex-col items-start">
                      <input
                        ...
                        className="block w-full mt-1 text-lg p-1 text-slate-900 border-gray-300 rounded-md border border-black-700 "
                        {...register('date')}
                        defaultValue={selectedExpense[0].date}
                      />
                      {errors.date && (
                        <p className="text-red-700 text-sm">
                          {errors.date.message}
                  ...
                  <div className="mt-2">
                    ...
                    <div className="flex flex-col items-start">
                      <input
                        ...
                        className="block w-full mt-1 text-lg p-1 text-slate-900 border-gray-300 rounded-md border border-black-700 "
                        {...register('amount')}
                        defaultValue={selectedExpense[0].amount}
                      />
                      {errors.amount && (
                        <p className="text-red-700 text-sm">
                  ...
                  <div className="mt-2">
                    ...
                    <div className="flex flex-col items-start">
                      <input
                        ...
                        className="block w-full mt-1 text-lg p-1 text-slate-900 border-gray-300 rounded-md border border-black-700 "
                        {...register('createdBy')}
                        defaultValue={selectedExpense[0].createdBy}
                      />
